...
<!--<script src="tooltipsy.min.js" type="text/javascript"></script>
...
print_html '<div class="onsale">Myyn DVD-leffani pois halvalla (3 &euro;/kpl). Pistä sähköpostia roni.laukkarinen@gmail.com tai viestiä Facebookissa. Himmeällä olevat jo varattu. <small>Päivitetty viimeksi: ';
